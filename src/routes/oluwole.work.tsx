...
export const Route = createFileRoute("/oluwole/work")({
  head: () => ({ meta: [
...
function Work() {
  return <>
    ...
    <section className="mx-auto max-w-[1240px] px-6 py-20 md:px-10"><Link to="/oluwole/contact" className="group inline-flex items-center gap-3 text-2xl font-semibold md:text-4xl">Have a complex idea? Let&apos;s make it clear. <ArrowUpRight className="transition-transform group-hover:-translate-y-1 group-hover:translate-x-1" /></Link></section>
  </>;
}
        ...
        <div className="relative mx-auto grid max-w-[1240px] grid-cols-12 gap-8 px-6 pb-24 pt-24 md:px-10 md:pb-32 md:pt-36">
          <div className="col-span-12 md:col-span-8">
            ...
            <div className="rise rise-delay-3 mt-10 flex flex-wrap gap-5">
              <Link to="/work" className="inline-flex items-center gap-3 bg-primary px-5 py-3 text-sm font-semibold text-primary-foreground transition-transform hover:-translate-y-1">View selected work <MoveRight size={16} /></Link>
              <Link to="/contact" className="inline-flex items-center gap-2 border border-border px-5 py-3 text-sm transition-colors hover:border-primary hover:text-primary">Get in touch <ArrowUpRight size={15} /></Link>
            </div>
          </div>
